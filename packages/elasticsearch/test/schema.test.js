...
describe('processSchemas()', () => {
  // es5, es6, es7
  it(
    'should return the correct schema, given an ES mapping with non-object properties,',
    () => {
  ...
  it(
    'should return the correct schema, given an ES mapping with types,',
    () => {
  ...
  // es7
  it(
    'should return the correct schema, when given an ES mapping without types,',
    () => {
      let expected = schemaWithoutTypes
