...
describe('Server Provider', () => {
  it(
    'groupCombinator should return a query joining filters by group.join',
    () => {
      expect(
  ...
  it(
    'runSearch should wrap queries in constant_score if sort._score is not present',
    () => {
      const client = {
  ...
  it(
    'runSearch should not wrap queries in constant_score if no query is given',
    () => {
      const client = {
        child: jest.fn().mockReturnValue({
          search: jest.fn().mockReturnValue(Promise.resolve({})),
  ...
  it(
    'runSearch should not wrap queries in constant_score if sort._score is present',
    () => {
      const client = {
        child: jest.fn().mockReturnValue({
          search: jest.fn().mockReturnValue(Promise.resolve({})),
  ...
  it(
    'should pass any request options to the child client upon initialization',
    () => {
      const client = {
        child: jest.fn().mockReturnValue({
          search: jest.fn().mockReturnValue(Promise.resolve({})),
