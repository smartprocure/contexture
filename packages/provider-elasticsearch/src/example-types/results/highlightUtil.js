...
export let mergeHitHighlights = ({pre_tags, post_tags}, fields, hitHighlights) => {
    ...
    if (field && hitHighlights[field] && hitHighlights[subField]) {
      ...
      let strippedField = removeHighlightTags({pre_tags, post_tags}, hitHighlights[field])
      ...
      highlights[field ? field : subField] = !highlights[subField] ? hitHighlights[subField] 
        : highlights[subField] 
    }
    return highlights
