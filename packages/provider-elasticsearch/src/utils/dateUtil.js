...
export let rangeToDatemath = {
  ...
  last24Months: { from: 'now/d-24M', to: 'now+1d/d-1ms' },
  last36Months: { from: 'now/d-36M', to: 'now+1d/d-1ms' },
  last48Months: { from: 'now/d-48M', to: 'now+1d/d-1ms' },
  last60Months: { from: 'now/d-60M', to: 'now+1d/d-1ms' },
