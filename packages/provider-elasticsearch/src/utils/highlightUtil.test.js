...
describe('Highlight field aggregation', () => {
  ...
  it('should combine subfield highlights with field highlights1', () => {
    ...
    let hitHighlights = {
      'LineItem.Description.exact': [
        'BRUSH,SCRUB: POT AND PAN SCRUB BRUSH WITH <b class="search-highlight">WOOD</b> HANDLE. BLOCK LENGTH 6-1/8" +1/2" - 1/8", WIDTH 2-1/2" +/- 1/4" 3/4" +1/4" = 1/8". FILLER 1-3/8"U/I EA. CARLISLE BRUSH P/N 365015 OR EQUAL',
      ],
      'PO.Description': [
        'BRUSH,SCRUB: POT AND PAN SCRUB BRUSH WITH WOOD HANDLE. BLOCK LENGTH 6-1/8" +1/2" - 1/8", WIDTH 2-1/2" +/- 1/4" 3/4" +1/4" = 1/8". <b class="search-highlight">FILLER</b> 1-3/8"U/I EA. CARLISLE BRUSH P/N 365015 OR EQUAL',
      ],
    ...
    expect(mergeHitHighlights(nodeHighlight, fields, hitHighlights)).toEqual({
      'LineItem.Description': [
        'BRUSH,SCRUB: POT AND PAN SCRUB BRUSH WITH <b class="search-highlight">WOOD</b> HANDLE. BLOCK LENGTH 6-1/8" +1/2" - 1/8", WIDTH 2-1/2" +/- 1/4" 3/4" +1/4" = 1/8". <b class="search-highlight">FILLER</b> 1-3/8"U/I EA. CARLISLE BRUSH P/N 365015 OR EQUAL',
      ],
      'PO.Description': [
        'BRUSH,SCRUB: POT AND PAN SCRUB BRUSH WITH WOOD HANDLE. BLOCK LENGTH 6-1/8" +1/2" - 1/8", WIDTH 2-1/2" +/- 1/4" 3/4" +1/4" = 1/8". <b class="search-highlight">FILLER</b> 1-3/8"U/I EA. CARLISLE BRUSH P/N 365015 OR EQUAL',
      ],
