...
let Label = _.flow(observer, withTheme)(
...
let CheckableResultTable = _.flow(contexturify, withTheme)(
  ({ node, fields, selected, getValue, theme: { Checkbox, ResultTable }, ...props }) => (
    <ResultTable
      fields={{
        _checkbox: {
          hideMenu: true,
